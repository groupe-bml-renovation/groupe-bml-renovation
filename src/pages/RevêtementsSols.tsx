...
const ImageCarousel = () => {
  ...
  const images = [
    ...
    'https://images.unsplash.com/photo-1615875474908-f403116f5125?w=800&q=80',
...
const RevêtementsSols: React.FC<RevêtementsSolsProps> = ({ onBack }) => {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-light text-white mb-8 leading-tight tracking-wide capitalize">
              Travaux Revêtements<br />Sols
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/80 max-w-3xl mx-auto mb-8 uppercase tracking-[0.3em] font-light">
              Des sols de qualité pour sublimer vos espaces de vie et de travail
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-light mb-6 leading-tight">
                <span className="text-[#38bdf8] font-normal">Transformer vos sols</span>{' '}
                <span className="text-slate-900">avec des</span><br />
                <span className="text-slate-900">solutions durables.</span>
              </h2>
              ...
              <p className="text-base text-slate-600 leading-relaxed mb-4">
                <strong>Groupe BML Rénovation</strong> met à votre service des <strong>poseurs qualifiés</strong> qui
                maîtrisent toutes les techniques de pose moderne. <strong>Notre équipe vous accompagne</strong> dans le
                choix des matériaux et des finitions pour créer un sol adapté à votre style de vie.
              </p>

              <p className="text-base text-slate-600 leading-relaxed">
                Que ce soit pour installer un parquet chaleureux, poser du carrelage élégant, ou choisir des revêtements
                vinyles pratiques, nos experts en sols réalisent des travaux précis qui valorisent vos espaces avec un
                rendu impeccable et une longévité garantie.
              </p>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12">
            <div className="bg-[#f5f5f5] p-8">
              ...
              <h2 className="text-3xl md:text-4xl font-light text-[#38bdf8] mb-6 leading-tight">
                Embellir vos<br />espaces intérieurs
              </h2>

              <p className="text-base text-[#4a5568] leading-relaxed mb-6">
                Groupe BML Rénovation tout corps d'état réalise tous vos travaux de revêtements de sols avec expertise et précision. De la préparation des supports à la pose finale, nos poseurs professionnels vous garantissent un résultat esthétique et résistant.
              </p>

              <p className="text-base text-[#4a5568] leading-relaxed">
                Notre expertise couvre tous les types de sols : parquet massif ou contrecollé, carrelage grès cérame, stratifié, vinyle PVC, moquette. Nous utilisons exclusivement des matériaux certifiés et écologiques pour votre confort et la protection de l'environnement.
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 bg-white p-6 rounded-lg">
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-[#4a5568]">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Sols vinyles et PVC</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Stratifié haute résistance</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Moquette résidentielle</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Préparation et ragréage</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-[#4a5568] leading-relaxed">
                    Groupe BML Rénovation Tout Corps D'état vous offre une expertise complète en revêtements de sols, avec des finitions impeccables et un service personnalisé adapté à chaque projet, du plus simple au plus complexe.
                  </p>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-light text-slate-900 mb-6 leading-tight">
                Une expertise complète<br />des revêtements de sols
              </h2>

              <p className="text-base text-slate-600 leading-relaxed">
                Groupe BML Rénovation Tout Corps D'état possède une expertise reconnue dans tous les domaines des revêtements de sols. Nos poseurs qualifiés maîtrisent les techniques traditionnelles et modernes pour réaliser des installations parfaites, du simple remplacement aux projets de rénovation les plus exigeants.
              </p>
            </div>
              ...
              <div className="px-6 pt-8 pb-6">
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Parquet massif et flottant</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Vinyle et PVC acoustique</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Stratifié haute densité</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Moquette et tapis</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden">
              ...
              <div className="px-6 pt-8 pb-6">
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Pose collée professionnelle</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Installation flottante</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
            ...
            <div className="bg-white overflow-hidden">
              ...
              <div className="px-6 pt-8 pb-6">
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Conseils choix matériaux</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Protection des espaces</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#38bdf8] mt-0.5 font-bold">›</span>
                    <span>Nettoyage post-chantier</span>
                  </li>
                </ul>
              </div>
            </div>
...
export default RevêtementsSols;
