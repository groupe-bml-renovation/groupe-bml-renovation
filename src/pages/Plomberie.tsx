...
import { Phone, Check, ChevronLeft, ChevronRight, Pen, Droplets, Layout, ShieldCheck, Ruler, Activity, Wrench } from 'lucide-react';
import { motion } from 'framer-motion';
import { FooterSection } from '../components/footer-section';
import { OptimizedImage } from '../components/OptimizedImage';
import ServiceFAQ from '../components/ServiceFAQ';
import { plomberieFAQs } from '../data/service-faqs';
            ...
            <div className="flex gap-6 animate-scroll">
              {images.map((img, index) => (
                <div key={`set1-${index}`} className="flex-shrink-0 w-80 h-64 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
                  <OptimizedImage
                    src={img}
                    alt={`Réalisation Plomberie ${index + 1}`}
...
const Plomberie: React.FC<PlomberieProps> = ({ onBack, onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>{isGrenoble ? "Plomberie & Chauffage à Grenoble | Installation & Dépannage | BML" : "Plomberie et Réseaux Premium | Installation & Chauffage | Groupe BML"}</title>
        <meta name="description" content="L'excellence technique pour vos réseaux fluides. Installation sanitaire, chauffage et dépannage certifié. Interlocuteur unique pour votre rénovation complète." />
        <meta property="og:title" content="Plomberie & Chauffage Premium | Groupe BML" />
      ...
      <div className="sr-only">
        <h2>Expertise Plomberie & Chauffage</h2>
        <p>Installation et rénovation de réseaux hydrauliques et sanitaires</p>
        <h3>Plombier Chauffagiste Grenoble</h3>
        <h3>Installation Pompe à Chaleur</h3>
        <h3>Rénovation de Salle de Bain</h3>
        <h3>Mise en conformité réseaux fluides</h3>
      </div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <OptimizedImage
            ...
            alt="Ingénierie plomberie premium"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-light text-white mb-8 leading-tight tracking-wide">
              {isGrenoble ? (
                <>Plomberie sur Mesure<br />à Grenoble</>
              ) : (
                <>Plomberie &<br />Haute Précision</>
              )}
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/80 max-w-3xl mx-auto mb-8 uppercase tracking-[0.3em] font-light">
              {isGrenoble ? "La maîtrise absolue de vos réseaux fluides à Grenoble" : "L'excellence technique au service de votre confort en Isère"}
            </p>
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-10">
                <div className="flex items-center gap-3 group">
                  ...
                  <span className="font-semibold text-slate-900">Réseaux Certifiés NF</span>
                </div>
                <div className="flex items-center gap-3 group">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-[#38bdf8] group-hover:bg-[#38bdf8] group-hover:text-white transition-all duration-300">
                    <Check className="w-5 h-5" />
            ...
            >
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
                <OptimizedImage
                  ...
                  alt="Installation technique plomberie"
                  className="w-full h-full object-cover"
                />
              </div>
            </motion.div>
            ...
            <div className="lg:pr-12 order-2 lg:order-1">
              ...
              <div className="text-center bg-gradient-to-r from-[#38bdf8] to-blue-600 rounded-3xl p-12 text-white mt-8 shadow-2xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {isGrenoble ? "Un expert en plomberie à Grenoble ?" : "Votre installation clé en main"}
                </h2>
                <p className="text-lg mb-8 opacity-90">
                  {isGrenoble
                    ? "Nos techniciens basés à Grenoble sécurisent l'intégralité de vos fluides."
                    : "Un accompagnement premium pour une plomberie d'exception."}
                </p>
                <button
                  onClick={scrollToContactForm}
            ...
            <div className="order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl skew-y-2">
                <OptimizedImage
                  ...
                  alt="Détails technique plomberie"
      ...
      <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 italic">Votre projet fluides en 4 étapes clés</h2>
          ...
          <div className="bg-slate-50 rounded-[3.5rem] p-12 md:p-24 shadow-2xl border border-slate-100 grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-4 mb-12">
                ...
                <div className="flex items-center gap-4 text-slate-800 font-medium">
                  <div className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-[#38bdf8]"><Check className="w-5 h-5" /></div>
                  <span className="italic">Sélection de matériaux haut de gamme</span>
                </div>
              </div>
      ...
      <section className="pt-10 pb-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12 items-start">
            <div>
              <span className="text-sm font-semibold uppercase tracking-wide text-[#38bdf8]">
                {isGrenoble ? "NOTRE SAVOIR-FAIRE ISÈRE" : "EXCELLENCE FLUIDES"}
              </span>

              <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 leading-tight italic">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  L'expertise à chaque raccordement
                </span>
              </h2>
              ...
              {[
                {
                  ...
                  title: "Réseaux",
                  items: ["Distribution Multicouche", "Évacuations silencieuses", "Répartiteurs isolés", "Réseaux de gaz certifiés", "Traitement de l'eau"]
                },
                {
                  icon: <Droplets className="w-10 h-10" />,
                  title: "Sanitaires",
                  items: ["Robineterie encastrée", "Douches à l'italienne", "W.C. Suspendus", "Vasques & Baignoires", "Chauffe-eau thermodynamique"]
                },
                {
                  icon: <ShieldCheck className="w-10 h-10" />,
                  title: "Chauffage",
                  items: ["Pompes à Chaleur (PAC)", "Radiateurs basse temp", "Planchers chauffants", "Climatisation réversible", "Régulation intelligente"]
                }
              ].map((card, i) => (
                <motion.div
                  key={i}
