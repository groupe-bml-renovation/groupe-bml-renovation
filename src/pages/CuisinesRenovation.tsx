...
import { Phone, Check, ChevronLeft, ChevronRight, Pen, Utensils, Layout, ShieldCheck, Ruler } from 'lucide-react';
import { motion } from 'framer-motion';
import { FooterSection } from '../components/footer-section';
import { OptimizedImage } from '../components/OptimizedImage';
import ServiceFAQ from '../components/ServiceFAQ';
import { cuisineFAQs } from '../data/service-faqs';
...
const ImageCarousel = () => {
  ...
  const images = [
    'https://images.unsplash.com/photo-1556911223-e1530286862d?w=1200&q=80',
    'https://images.unsplash.com/photo-1556912172-45b7abe8b7e1?w=1200&q=80',
    'https://images.unsplash.com/photo-1556184980-0a2569502b48?w=1200&q=80',
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-light text-white mb-8 leading-tight tracking-wide">
              {isGrenoble ? (
                <>
                  Rénovation cuisine<br />à Grenoble
                </>
              ) : (
                <>
                  Rénovation cuisine<br />premium
                </>
              )}
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/80 max-w-3xl mx-auto mb-8 uppercase tracking-[0.3em] font-light">
              {isGrenoble ? "Le design culinaire au cœur de l'Isère" : "L'excellence au service de votre convivialité"}
            </p>
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 leading-tight">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  {isGrenoble 
                    ? "Sublimez votre cuisine à Grenoble" 
                    : "L'art de la gastronomie à domicile"}
                </span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12">
            <div className="bg-[#f5f5f5] p-8">
              <span className="text-sm font-semibold uppercase tracking-wide text-[#38bdf8]">
                {isGrenoble ? "CONCEPTION ISÈRE" : "SAVOIR-FAIRE"}
              </span>
              <div className="w-24 h-px bg-[#38bdf8] mb-6"></div>

              <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-6">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  {isGrenoble ? "Expertise Cuisine à Grenoble" : "L'intelligence culinaire"}
                </span>
              </h2>
            ...
            <div className="flex flex-col gap-6">
              <div className="grid md:grid-cols-2 gap-6 bg-white p-6 rounded-lg">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-[#38bdf8]">Lots techniques</h3>
                  </div>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Agencement de meubles sur mesure</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Installation de plans de travail premium</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Mise aux normes électriques spécialisée</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Réseaux plomberie & Évacuations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Éclairage LED intégré & Spots</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Revêtements de sols techniques & Faïences</span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="text-center bg-gradient-to-r from-[#38bdf8] to-blue-600 rounded-3xl p-12 text-white mt-8">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {isGrenoble ? "Un projet de cuisine à Grenoble ?" : "Prêt pour une nouvelle cuisine ?"}
                </h2>
                <p className="text-lg mb-6 opacity-90">
                  {isGrenoble
                    ? "Nos experts grenoblois conçoivent votre espace gourmand."
            ...
            >
              <div>
                ...
                <h2 className="text-3xl md:text-5xl font-bold mt-4 mb-6 leading-tight">
                  <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                    Accompagnement d'architecte offert pour votre cuisine
                  </span>
                </h2>
              </div>
              ...
              <div className="space-y-6 text-slate-700 leading-relaxed text-lg">
                <p>
                  Une cuisine réussie ne s'improvise pas. Chez <span className="text-black font-semibold">Groupe BML Rénovation</span>, nous croyons que l'ergonomie culinaire doit être accessible. C'est pourquoi nous avons scellé un <span className="text-black font-semibold">partenariat with Espaces Alpins</span>.
                </p>
                <p>
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="backdrop-blur-md bg-white/10 border border-white/20 p-6 rounded-2xl text-white">
                    ...
                    <p className="text-xl font-semibold">"Chaque cuisine est le récit d'une vie."</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              {[
                {
                  ...
                  title: "Modèles",
                  items: ["Cuisines en Îlot", "Cuisines en L / U", "Cuisines Linéaires", "Cuisines d'été", "Kitchenettes High-tech"]
                },
                {
                  icon: (
                  ...
                  title: "Composants",
                  items: ["Meubles Haut/Bas", "Quartz & Granit", "Électroménager", "Éclairage LED", "Crédences Verre/Inox"]
                },
                {
                  icon: (
                  ...
                  title: "Engagements",
                  items: ["Garantie Décennale", "Certifications RGE", "Délais de pose", "Assurance Pro", "Nettoyage Finition"]
                }
              ].map((card, i) => (
                <motion.div
                  key={i}
      ...
      <ServiceFAQ 
        ...
        description={isGrenoble ? "Retrouvez les réponses à vos questions sur la rénovation de cuisines à Grenoble." : "Retrouvez les réponses à vos questions sur l'aménagement de votre espace gourmand."}
      />
