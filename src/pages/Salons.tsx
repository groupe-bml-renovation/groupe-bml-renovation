...
import { Phone, Check, ChevronLeft, ChevronRight, Pen, Sofa, Layout, ShieldCheck, Ruler } from 'lucide-react';
import { motion } from 'framer-motion';
import { FooterSection } from '../components/footer-section';
import { OptimizedImage } from '../components/OptimizedImage';
import ServiceFAQ from '../components/ServiceFAQ';
import { salonFAQs } from '../data/service-faqs';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-light text-white mb-8 leading-tight tracking-wide">
              {isGrenoble ? (
                <>
                  Salons & séjours<br />à Grenoble
                </>
              ) : (
                <>
                  Salons & séjours<br />d'exception
                </>
              )}
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/80 max-w-3xl mx-auto mb-8 uppercase tracking-[0.3em] font-light">
              {isGrenoble ? "L'élégance au cœur de votre foyer isérois" : "L'art de repenser votre espace de vie"}
            </p>
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 leading-tight">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  {isGrenoble 
                    ? "Repenser votre séjour à Grenoble" 
                    : "L'art de l'espace de vie"}
                </span>
              </h2>
          ...
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12">
            <div className="bg-[#f5f5f5] p-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-6">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  {isGrenoble ? "Design d'Espace à Grenoble" : "Le sens du détail"}
                </span>
              </h2>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-full border-2 border-[#38bdf8] flex items-center justify-center bg-white">
                       <Sofa className="w-6 h-6 text-[#38bdf8]" />
                    </div>
                    <h3 className="text-xl font-bold text-[#38bdf8]">Transformations</h3>
                  </div>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Ouverture de murs porteurs (IPN)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Menuiseries sur mesure & bibliothèques</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#38bdf8]">–</span>
                      <span>Climatisation réversible & Chauffage sol</span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="text-center bg-gradient-to-r from-[#38bdf8] to-blue-600 rounded-3xl p-12 text-white mt-8">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {isGrenoble ? "Un projet de salon à Grenoble ?" : "Prêt pour un nouveau séjour ?"}
                </h2>
                <p className="text-lg mb-6 opacity-90">
                  {isGrenoble
                    ? "Nos experts grenoblois conçoivent votre espace sur mesure."
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-6 pt-4 pb-8">
                {[
                  ...
                  { title: "Mise aux normes", desc: "Électricité & isolation performante", icon: "🧱" },
              ...
              <div className="flex flex-wrap gap-6 items-center">
                ...
                >
                  ...
                  Transformer mon salon maintenant
                  <div className="flex flex-col items-center ml-1">
                    <Pen className="w-4 h-4 flex-shrink-0" strokeWidth={2.5} />
                    <div className="w-6 h-0.5 bg-current rounded-full mt-1"></div>
                  </div>
              ...
              {[
                {
                  ...
                  title: "Espaces",
                  items: ["Salons & Séjours", "Salles à manger", "Bibliothèques", "Halls d'entrée", "Espaces Home Cinéma"]
                },
                {
                  icon: (
                  ...
                  title: "Lots",
                  items: ["Peintures & Stucco", "Parquets & Revêtements", "Plâtrerie & Faux-plafonds", "Éclairage & Domotique", "Agencement sur mesure"]
                },
                {
                  icon: (
                  ...
                  title: "Engagements",
                  items: ["Garantie Décennale", "Labels RGE & Qualibat", "Délais Garantis", "Assurance Pro", "Nettoyage Soigné"]
                }
              ].map((card, i) => (
                <motion.div
                  key={i}
