...
import { Phone, Check, ChevronLeft, ChevronRight, Pen, Wind, Thermometer, ShieldCheck, Ruler, Layout, Snowflake, CloudRain } from 'lucide-react';
import { motion } from 'framer-motion';
import { FooterSection } from '../components/footer-section';
import { OptimizedImage } from '../components/OptimizedImage';
import ServiceFAQ from '../components/ServiceFAQ';
import { climFAQs } from '../data/service-faqs';
...
const ImageCarousel = () => {
  ...
  const images = [
    ...
    'https://images.unsplash.com/photo-1599814202151-3e47952eb0b4?w=800&q=80',
    'https://images.unsplash.com/photo-1636137681404-03460f9ed6cd?w=800&q=80',
    'https://images.unsplash.com/photo-1581094794329-c8112c4e5190?w=800&q=80',
    'https://images.unsplash.com/photo-1621905252507-b354bcadc0e1?w=800&q=80'
  ];
            ...
            <div className="flex gap-6 animate-scroll">
              {images.map((img, index) => (
                <div key={`set1-${index}`} className="flex-shrink-0 w-80 h-64 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
                  <OptimizedImage
                    src={img}
                    alt={`Réalisation Climatisation ${index + 1}`}
...
const Climatisation: React.FC<ClimatisationProps> = ({ onBack, onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>{isGrenoble ? "Climatisation & Pompe à Chaleur à Grenoble | BML" : "Climatisation Réversible & PAC Premium | Expert Thermique | Groupe BML"}</title>
        <meta name="description" content="Confort thermique absolu toute l'année. Systèmes gainables invisibles, bi-splits design et pompes à chaleur haute performance. Excellence certifiée en Isère." />
        <meta property="og:title" content="Climatisation & Confort Thermique | Groupe BML" />
      ...
      <div className="sr-only">
        ...
        <h3>Entretien Climatisation Isère</h3>
      </div>

      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <OptimizedImage
            src="https://images.unsplash.com/photo-1621905252507-b354bcadc0e1?w=1920&q=80"
            alt="Intégration climatisation design"
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-light text-white mb-8 leading-tight tracking-wide">
              {isGrenoble ? (
                ...
                <>Confort Thermique<br />Invisible</>
              )}
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/80 max-w-3xl mx-auto mb-8 uppercase tracking-[0.3em] font-light">
              {isGrenoble ? "L'assurance d'une température idéale toute l'année à Grenoble" : "La maîtrise thermodynamique au service de votre sérénité"}
            </p>
            ...
            >
              ...
              >
                Planifier mon confort thermique
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 leading-tight">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  L'intelligence thermodynamique pour votre habitat
                </span>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-10">
                <div className="flex items-center gap-3 group">
                  ...
                  <span className="font-semibold text-slate-900">Filtration Haute Performance</span>
                </div>
                <div className="flex items-center gap-3 group">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-[#38bdf8] group-hover:bg-[#38bdf8] group-hover:text-white transition-all duration-300">
                    <Check className="w-5 h-5" />
                  </div>
                  <span className="font-semibold text-slate-900">Silence Absolu Premium</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
                <OptimizedImage
                  ...
                  alt="Technologie climatisation réversible"
                  className="w-full h-full object-cover"
                />
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
          <h2 className="text-4xl font-bold text-slate-900 mb-6 italic">Architecture Thermique</h2>
          <p className="text-slate-600 max-w-2xl mx-auto italic">Des installations climatiques qui se fondent dans votre design intérieur.</p>
        </div>
        <ImageCarousel />
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center flex-row-reverse">
            <div className="lg:pr-12 order-2 lg:order-1">
              ...
              <div className="text-center bg-gradient-to-r from-[#38bdf8] to-blue-600 rounded-3xl p-12 text-white mt-8 shadow-2xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {isGrenoble ? "Un expert climatisation à Grenoble ?" : "Votre confort thermodynamique"}
                </h2>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl -skew-y-2">
                <OptimizedImage
                  src="https://images.unsplash.com/photo-1636137681404-03460f9ed6cd?w=1200&q=80"
                  alt="Détails techniques climatisation gainable"
      ...
      <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <span className="text-[#38bdf8] font-bold uppercase tracking-widest text-sm mb-4 block">Protocole Technique</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-8 italic">Votre confort thermique en 4 temps</h2>
            ...
            >
              ...
              <div className="space-y-4 mb-12">
                <div className="flex items-center gap-4 text-slate-800 font-medium">
                  ...
                  <span className="italic">Intégration millimétrée en faux-plafonds</span>
                </div>
                <div className="flex items-center gap-4 text-slate-800 font-medium">
                  <div className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-[#38bdf8]"><Check className="w-5 h-5" /></div>
                  <span className="italic">Sélection de grilles de diffusion architecturales</span>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  title: "Chaleur",
                  items: ["PAC Air-Air Réversible", "PAC Air-Eau Split", "Consoles design", "Relève de chaudière", "Pilotage WiFi"]
                },
                {
                  icon: <Snowflake className="w-10 h-10" />,
                  title: "Engagement",
                  items: ["Certification Capacité", "Label QualiPAC", "Garantie décennale", "Contrat Maintenance", "Bilan Thermique"]
                }
              ].map((card, i) => (
                <motion.div
                  key={i}
      ...
      <section className="py-16 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 leading-tight italic">
              <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                Nos certifications pour votre climat
              </span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4 md:gap-6">
            {[
              ...
              { name: 'QualiPAC', logo: 'https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Certifications%20logos%2012.png', desc: 'Label QualiPAC' },
              { name: 'Fluides', logo: 'https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Certifications%20logos%2006.png', desc: 'Certifié Fluides' },
              { name: 'Thermique', logo: 'https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Certifications%20logos%2005.png', desc: 'Expert Chaleur' },
              ...
              { name: 'Audit', logo: 'https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Certifications%20logos%2004.png', desc: 'Bilan Thermique' },
            ].map((cert, i) => (
              <motion.div
                key={i}
