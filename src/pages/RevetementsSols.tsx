...
import { Phone, Check, ChevronLeft, ChevronRight, Pen, Hammer, Ruler, Layout, Database, ShieldCheck, Grid3X3, Layers } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="sr-only">
        ...
        <h3>Sols LVT & Vinyles de Luxe</h3>
      </div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <OptimizedImage
            ...
            alt="Intérieur avec parquet noble"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-light text-white mb-8 leading-tight tracking-wide">
              {isGrenoble ? (
                <>Sols d'Exception<br />à Grenoble</>
              ) : (
                <>L'Élégance sous<br />vos pas</>
              )}
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/80 max-w-3xl mx-auto mb-8 uppercase tracking-[0.3em] font-light">
              {isGrenoble ? "Les plus beaux revêtements au service de votre habitat grenoblois" : "L'excellence des matériaux au service de votre architecture intérieure"}
            </p>
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 leading-tight">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  L'ancrage esthétique de votre architecture
                </span>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-10">
                <div className="flex items-center gap-3 group">
                  ...
                  <span className="font-semibold text-slate-900">Pose Laser Millimétrée</span>
                </div>
                <div className="flex items-center gap-3 group">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-[#38bdf8] group-hover:bg-[#38bdf8] group-hover:text-white transition-all duration-300">
                    <Check className="w-5 h-5" />
                  </div>
                  <span className="font-semibold text-slate-900">Sélection Matériaux Luxe</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
                <OptimizedImage
                  ...
                  alt="Pose de carrelage grand format"
                  className="w-full h-full object-cover"
                />
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center flex-row-reverse">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl -skew-y-2">
                <OptimizedImage
                  src="https://images.unsplash.com/photo-1598718544285-7180f670198b?w=1200&q=80"
                  alt="Détails pose carrelage luxe"
      ...
      <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <span className="text-[#38bdf8] font-bold uppercase tracking-widest text-sm mb-4 block">Protocole Solier</span>
          ...
          <div className="bg-slate-50 rounded-[3.5rem] p-12 md:p-24 shadow-2xl border border-slate-100 grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-slate-700 leading-relaxed text-lg italic">
                <p>
                  Parce qu'un sol définit l'âme de votre intérieur, nous collaborons with <span className="font-bold text-slate-900 underline decoration-[#38bdf8]">Espaces Alpins</span>. Bénéficiez de l'expertise d'un architecte d'intérieur for le choix de vos matériaux, le calepinage and l'harmonie with votre décoration.
                </p>
              </div>
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="backdrop-blur-md bg-white/20 border border-white/30 p-6 rounded-2xl text-white">
                    ...
                    <p className="text-xl font-semibold">"Le sol est la symphonie muette qui unit chaque pièce."</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="pt-10 pb-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12 items-start">
            <div>
              <span className="text-sm font-semibold uppercase tracking-wide text-[#38bdf8]">
                {isGrenoble ? "NOTRE SAVOIR-FAIRE ISÈRE" : "EXCELLENCE SOLIER"}
              </span>

              <h2 className="text-3xl md:text-4xl font-bold mt-4 mb-6 leading-tight italic">
                <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">
                  L'expertise à chaque calepinage
                </span>
              </h2>
              ...
              {[
                {
                  ...
                  title: "Carrelage",
                  items: ["Dalles XXL Grand Format", "Grès Cérame Italien", "Faïence Haut de Gamme", "Carreaux de Ciment", "Douches à l'italienne"]
                },
                {
                  icon: <Hammer className="w-10 h-10" />,
                  title: "Parquets",
                  items: ["Chêne Point de Hongrie", "Bâtons Rompus Nobles", "Parquet Massif / Contrecollé", "Rénovation & Vitrification", "Huiles Naturelles Luxes"]
                },
                {
                  icon: <ShieldCheck className="w-10 h-10" />,
                  title: "Techniques",
                  items: ["Ragréage Forte Épaisseur", "Sols LVT de Prestige", "Isolation Acoustique Pro", "Béton Ciré Design", "Résines Époxy Loft"]
                }
              ].map((card, i) => (
                <motion.div
                  key={i}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4 md:gap-6">
            {[
              ...
              { name: 'Solier', logo: 'https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Certifications%20logos%2007.png', desc: 'Savoir-Faire Pro' },
              ...
              { name: 'Audit', logo: 'https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Certifications%20logos%2004.png', desc: 'Plan & Design' },
      ...
      <ServiceFAQ
        ...
        items={[
          ...
          {
            id: "rs4",
            question: "Gérez-vous la vitrification des parquets anciens ?",
            answer: "Absolument. Nos parqueteurs restaurent vos bois anciens par un ponçage fin (grain successif) before d'appliquer une protection haute résistance (vernis PU, huile ou cire) for leur redonner tout leur lustre originel."
          },
          {
            id: "rs5",
