  ...
  return (
    <div className="min-h-screen bg-white pt-24">
      <Helmet>
        ...
        <meta property="og:title" content={isGrenoble ? "Rénovation Maison Grenoble - Entreprise de Rénovation Complète - BML Rénovation" : "Rénovation Maison Complète - Entreprise de Rénovation - BML Rénovation"} />
        <meta property="og:description" content={isGrenoble ? "Services de rénovation maison à Grenoble. Travaux de rénovation complète, intérieur/extérieur. Peinture, plomberie, électricité. Devis gratuit pour vos travaux Isère." : "Services de rénovation maison complète. Travaux de rénovation intérieure et extérieure. Peintre en bâtiment expérimenté. Devis gratuit pour vos travaux maison."} />
