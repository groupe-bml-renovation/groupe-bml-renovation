...
import { Accessibility, Hammer, Layers, Wind, Home } from 'lucide-react';

const InteractiveSelector3 = () => {
  ...
  const options = [
    {
      ...
      description: "Salle de bain adaptée aux personnes à mobilité réduite",
    ...
    },
    {
      ...
      description: "Tous travaux de menuiserie intérieure et extérieure",
      image: "https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Untitled%20design%20(48).png",
      icon: <Hammer size={24} className="text-white" />
    },
    {
      title: "Plâtrerie",
      description: "Cloisons, enduits et finitions plâtre",
      image: "https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Untitled%20design%20(43).png",
      icon: <Layers size={24} className="text-white" />
    },
    {
      title: "Ventilation et chauffage",
      description: "Installation et rénovation systèmes de chauffage",
    ...
    },
    {
      ...
      description: "Aménagement total de vos espaces",
  ...
  return (
    <div className="relative flex flex-col items-center justify-center bg-white font-sans text-slate-900 px-4">
      {/* Options Container */}
...
export default InteractiveSelector3;