...
const InteractiveSelectorServices = () => {
  const [activeIndex, setActiveIndex] = useState(0);
  const [animatedOptions, setAnimatedOptions] = useState<number[]>([]);

  const options = [
    {
      title: "Électricité et Borne électrique",
      description: "Installation et rénovation électrique",
      image: "https://pub-b2e43cc835de44a7830034d539ae5fe1.r2.dev/Untitled%20design-3.png",
      icon: <Zap size={24} className="text-white" />
    },
    {
      title: "Plomberie",
      description: "Services de plomberie professionnels",
      image: "https://images.unsplash.com/photo-1676210134188-4c05dd172f89?ixlib=rb-4.1.0&auto=format&fit=crop&q=80&w=500",
  ...
  return (
    <div className="relative flex flex-col items-center justify-center bg-white font-sans text-slate-900 px-2 sm:px-4 py-0 w-full">
...
export default InteractiveSelectorServices;
