...
import { Hammer, Home, Lightbulb, Droplet, Layers } from 'lucide-react';
  ...
  const options = [
    {
      ...
      description: "Services complets de rénovation",
      image: "https://images.pexels.com/photos/3584488/pexels-photo-3584488.jpeg?auto=compress&cs=tinysrgb&w=600",
      icon: <Hammer size={24} className="text-white" />
    },
    {
      title: "Aménagement Intérieur",
      description: "Conception et aménagement personnalisé",
    ...
    },
    {
      ...
      description: "Plomberie et sanitaires modernes",
      image: "https://images.pexels.com/photos/5824502/pexels-photo-5824502.jpeg?auto=compress&cs=tinysrgb&w=600",
      icon: <Droplet size={24} className="text-white" />
    },
    {
      title: "Finitions Premium",
      description: "Revêtements et peinture haut de gamme",
      image: "https://images.pexels.com/photos/3556408/pexels-photo-3556408.jpeg?auto=compress&cs=tinysrgb&w=600",
        ...
        {options.map((option, index) => (
          <div
            ...
            style={{
              ...
              borderWidth: '2px',
              borderStyle: 'solid',
              borderColor: activeIndex === index ? '#0ea5e9' : '#e2e8f0',
              cursor: 'pointer',
          ...
          >
            ...
            <div className="label absolute left-0 right-0 bottom-3 md:bottom-5 flex items-center justify-start h-10 md:h-12 z-2 pointer-events-none px-2 md:px-4 gap-2 md:gap-3 w-full">
              <div className="icon min-w-[32px] md:min-w-[44px] max-w-[32px] md:max-w-[44px] h-[32px] md:h-[44px] flex items-center justify-center rounded-full bg-[rgba(14,165,233,0.9)] backdrop-blur-[10px] shadow-[0_1px_4px_rgba(0,0,0,0.18)] border-2 border-[#0ea5e9] flex-shrink-0 flex-grow-0 transition-all duration-200">
