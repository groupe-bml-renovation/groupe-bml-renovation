...
const PolitiqueConfidentialite: React.FC<PolitiqueConfidentialiteProps> = ({ isOpen, onClose }) => {
        ...
        <div className="p-6 space-y-6">
          <div>
            <p className="text-gray-700 leading-relaxed mb-6">
              Le site web bml-renovation.fr est détenu par BML Rénovation, qui est un contrôleur de données de vos données personnelles.
            </p>
            <p className="text-gray-700 leading-relaxed mb-6">
              Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par bml-renovation.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de bml-renovation.fr.
            </p>
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Les informations personnelles que nous collectons</h3>
            <p className="text-gray-700 leading-relaxed">
              Lorsque vous visitez le bml-renovation.fr, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme "informations sur les appareils". En outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans s'y limiter, le nom, le prénom, l'adresse, les informations de paiement, etc.) lors de l'inscription afin de pouvoir exécuter le contrat.
            </p>
          </div>

          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Pourquoi traitons-nous vos données ?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Liens vers d'autres sites web</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Sécurité de l'information</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Divulgation légale</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à bml.renovation.pro@gmail.com.
            </p>
          </div>
        </div>
      </div>
