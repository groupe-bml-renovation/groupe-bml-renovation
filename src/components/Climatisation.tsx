...
const ImageCarousel = () => {
  ...
  const images = [
    ...
    'https://images.unsplash.com/photo-1631545806609-57f7ffe7bfe0?w=800&q=80',
    'https://images.unsplash.com/photo-1604709177225-055f99402ea3?w=800&q=80',
    'https://images.unsplash.com/photo-1635274939146-e3eec0b95444?w=800&q=80',
    'https://images.unsplash.com/photo-1581092056-0c4c3acd3789?w=800&q=80',
    'https://images.unsplash.com/photo-1581092334651-ddf26d9a09d0?w=800&q=80',
    'https://images.unsplash.com/photo-1525268771113-32d9e9021a97?w=800&q=80',
    'https://images.unsplash.com/photo-1585771724661-174e6d854bf4?w=800&q=80'
  ];
...
const Climatisation: React.FC<ClimatisationProps> = ({ onBack }) => {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-light text-white mb-8 leading-tight tracking-wide capitalize">
              Installation de<br />climatisation
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-light mb-6 leading-tight">
                ...
                <span className="text-slate-900">confort toute l'année.</span>
              </h2>

              <p className="text-base text-slate-600 leading-relaxed mb-4">
                Bénéficiez d'une température agréable en toutes saisons grâce à des systèmes de climatisation
                modernes, performants et économes en énergie qui s'adaptent parfaitement à vos besoins.
              </p>

              <p className="text-base text-slate-600 leading-relaxed mb-4">
                <strong>Groupe BML Rénovation</strong> vous accompagne dans tous vos <strong>projets
                d'installation de climatisation</strong>. L'équipe <strong>vous conseille et vous
                accompagne</strong> dans le choix du système le plus adapté à votre logement et à vos besoins spécifiques.
              </p>

              <p className="text-base text-slate-600 leading-relaxed">
                Que vous souhaitiez installer une climatisation réversible, rafraîchir des bureaux, améliorer
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1604709177225-055f99402ea3?w=1920&q=80"
                alt="Installation de Climatisation"
          ...
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12">
            <div className="bg-[#f5f5f5] p-8">
              ...
              <p className="text-base text-[#4a5568] leading-relaxed mb-6">
                Groupe BML Rénovation tout corps d'état conçoit et réalise tous types d'installations de climatisation. De l'étude thermique à la mise en service, nos techniciens qualifiés vous accompagnent tout au long de votre projet pour garantir un confort optimal et une efficacité énergétique maximale.
              </p>

              <p className="text-base text-[#4a5568] leading-relaxed">
                Notre approche globale garantit une prise en charge complète de votre projet : diagnostic personnalisé, dimensionnement du système, conseil sur les équipements les plus adaptés, et suivi rigoureux de chaque étape d'installation pour un résultat performant et durable.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr,2fr] gap-12 items-start">
            <div>
              ...
              <p className="text-base text-slate-600 leading-relaxed">
                Groupe BML Rénovation Tout Corps D'état possède une solide expérience dans tous types d'installations de climatisation. Notre expertise couvre tous les aspects : étude thermique et dimensionnement, climatisation réversible et pompes à chaleur, systèmes mono et multi-splits, climatisation gainable, raccordements frigorifiques certifiés, et maintenance préventive pour un rendement optimal.
              </p>
            </div>
      ...
      <section className="w-full px-4 md:px-8 lg:px-12 xl:px-16 py-8 bg-slate-50">
        <div className="w-full max-w-7xl mx-auto">
          <div className="text-center bg-gradient-to-r from-[#38bdf8] to-blue-600 rounded-3xl p-12 text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              Profitez d'un confort thermique optimal toute l'année avec nos solutions performantes.
            </p>
            <p className="text-base mb-8 opacity-90">
