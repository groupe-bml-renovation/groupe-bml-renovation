...
interface SocialProofBannerTransparentProps {
  stats?: StatItem[];
}
...
const SocialProofBannerTransparent: React.FC<SocialProofBannerTransparentProps> = ({ stats }) => {
  ...
  return (
    <section ref={ref} className="relative bg-transparent pt-0 pb-8 px-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
        {displayStats.map((stat, index) => (
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-lg p-6 text-center hover:shadow-xl hover:bg-white/15 transition-all duration-300 flex flex-col items-center justify-center"
          >
...
export default SocialProofBannerTransparent;
