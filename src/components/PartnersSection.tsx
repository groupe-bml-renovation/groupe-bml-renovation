...
export default function PartnersSection({
  ...
  return (
    <section className={`${reducedPadding ? 'pt-0' : 'pt-12'} pb-0 bg-transparent ${topSpacing}`}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <PartnerCarousel partners={partners} scrollDirection={scrollDirection} slowAnimation={slowAnimation} />
