...
export default function UnifiedContactForm({ hideLogos = false }: UnifiedContactFormProps) {
  ...
  return (
    <div id="contact-form" className={`bg-white text-gray-900 px-6 sm:px-10 lg:px-12 flex flex-col items-center ${hideLogos ? 'py-4 lg:py-6' : 'py-6 lg:py-10'}`}>
      <ImageModal 
        isOpen={modalOpen} 
      ...
      <div className="max-w-[1440px] mx-auto w-full">
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-12 lg:items-center ${hideLogos ? 'mb-8' : 'mb-12'}`}>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="order-1 lg:order-2 lg:col-start-2 space-y-6 pt-4 lg:pt-0"
          >
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              <strong className="font-bold">Après réception du devis, vous aurez une estimation détaillée</strong> de vos travaux de rénovation.
            </p>
          ...
          >
            ...
            <div className="pt-8 flex flex-row items-center justify-center sm:justify-start w-full gap-4 sm:gap-8">
              <div className="flex flex-col items-center justify-center">
                <div className="flex justify-center mb-3">
                  <svg className="h-8 w-auto sm:h-10" viewBox="0 0 272 92" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex justify-center gap-1.5 mb-2">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5" viewBox="0 0 24 24" fill="#FFB800" xmlns="http://www.w3.org/2000/svg">
