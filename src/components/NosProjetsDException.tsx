...
const NosProjetsDException: React.FC = () => {
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-4xl font-bold mb-6">
            <span className="bg-gradient-to-r from-black to-[#38bdf8] bg-clip-text text-transparent">Nos projets d'exception</span>
          </h2>
        ...
        >
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="relative w-full aspect-video sm:aspect-[16/10] lg:aspect-video rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
              ...
              <button
                ...
                className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-black/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-black/90 transition-colors z-10"
              >
              ...
              <button
                ...
                className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-black/80 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-black/90 transition-colors z-10"
              >
                <ChevronRight className="w-5 h-5 sm:w-6 sm:h-6" />
              </button>

              <div className="absolute bottom-3 sm:bottom-8 left-1/2 -translate-x-1/2 bg-black/70 backdrop-blur-sm text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-xs sm:text-sm font-medium z-10">
            ...
            >
              {currentImages.map((image, idx) => (
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className={`flex-shrink-0 w-28 h-16 sm:w-36 sm:h-20 rounded-lg overflow-hidden transition-all duration-300 border-2 ${
...
export default NosProjetsDException;
